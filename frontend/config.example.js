const config = {
    ...
    endpoints: {
        local: {
            ...
            guestLogin: 'http://localhost/api/guest-login',
            logout: 'http://localhost/api/logout',
            changePassword: 'http://localhost/api/users/change-password',
            passwordResetRequest: 'http://localhost/api/password-reset/request',
            passwordResetConfirm: 'http://localhost/api/password-reset/confirm',
        ...
        production: {
            ...
            loginPage: 'https://<your-domain>/research/IDEA/login.html',
            guestLogin: 'https://<your-domain>/api/guest-login',
            ...
            passwordResetRequest: 'https://<your-domain>/idea-api/password-reset/request',
            passwordResetConfirm: 'https://<your-domain>/idea-api/password-reset/confirm',
