...
def get_custom_instructions(host, user_id, session_id, static_dir, upload_dir, pqa_settings_name):
    ...
    return f"""
            ...
            Use it when:
                - Asked to perform literature review or "Knowledge Base" review.
                - The query involves specific scientific methods, findings, or technical details.
                - The answer requires citation from a primary source.
                - General knowledge may not provide a complete or accurate response.
