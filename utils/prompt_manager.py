...
class PromptManager:
    ...
    def _initialize_default_prompts(self):
        ...
        # Set default as the active prompt
        self._set_active_prompt("default")
    ...
    def _get_active_prompt_id(self) -> Optional[str]:
    ...
    def get_active_prompt(self) -> str:
        ...
        active_id = self._get_active_prompt_id()
        if not active_id:
            # Fallback to first available prompt
            prompts = self._load_prompts()
            if prompts:
                active_id = list(prompts.keys())[0]
                self._set_active_prompt(active_id)
            else:
                return ""
    ...
    def create_prompt(self, name: str, description: str, content: str) -> Dict:
        ...
        active_id = self._get_active_prompt_id()
        new_prompt["is_active"] = prompt_id == active_id
    ...
    def update_prompt(self, prompt_id: str, name: Optional[str] = None, 
        ...
        # Add is_active field for API response
        active_id = self._get_active_prompt_id()
        updated_prompt = prompts[prompt_id].copy()
        updated_prompt["is_active"] = prompt_id == active_id
    ...
    def delete_prompt(self, prompt_id: str) -> bool:
        ...
        if prompt_id == active_id:
            ...
            if remaining_prompts:
                ...
                self._set_active_prompt(new_active)
            else:
    ...
    def set_active_prompt(self, prompt_id: str) -> bool:
        ...
        self._set_active_prompt(prompt_id)
