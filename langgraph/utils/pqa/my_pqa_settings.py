...
DEFAULT_LLM = os.getenv("PQA_LLM_MODEL", "gpt-6-luna")
...
def create_pqa_settings(
    ...
    Parameters:
        ...
        llm: The LLM model to use (default: gpt-6-luna)
        ...
        "model_list": [
            {
                ...
                "litellm_params": {
                    ...
                    "temperature": 1,
                    # PaperQA uses Chat Completions and may call tools. GPT-6
                    # Luna supports tools there with reasoning disabled.
