...
`gpt-6-sol` with medium reasoning on the Responses API. `IDEA_TOOL_MODEL`
keeps station and web helper inference on `gpt-6-luna`. Primary chat uses the internal
